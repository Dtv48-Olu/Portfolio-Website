        ...
        <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute -inset-[10px] opacity-50">
                    ...
                    <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-purple-500/30 rounded-full mix-blend-multiply filter blur-3xl animate-pulse animation-delay-200"></div>
                    <div className="absolute bottom-1/4 left-1/3 w-96 h-96 bg-pink-500/30 rounded-full mix-blend-multiply filter blur-3xl animate-pulse animation-delay-400"></div>
                </div>
            </div>
            ...
            <div className="relative z-10 max-w-4xl mx-auto text-center">
                ...
                <div className="mb-8 inline-block">
                    <div className="w-32 h-32 rounded-full bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 p-1 animate-fade-in">
                        <div
                ...
                <p className="text-lg text-slate-400 max-w-2xl mx-auto mb-8 leading-relaxed animate-fade-in animation-delay-400">
                    I build scalable systems, architect clean code, and turn
                    complex problems into elegant solutions. From full-stack
                    applications to game development, I thrive on technical
                ...
                <div className="flex flex-wrap items-center justify-center gap-4 mb-12 animate-fade-in animation-delay-400">
                    <a
                        ...
                        className="link-primary bg-blue-600 hover:bg-blue-700 text-white shadow-lg shadow-blue-500/50"
                    >
                        <svg
                            className="w-5 h-5"
                            fill="none"
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="link-primary bg-slate-800 hover:bg-slate-700 text-white border border-slate-700 shadow-lg"
                    >
                        <svg
                            className="w-5 h-5"
                            fill="currentColor"
